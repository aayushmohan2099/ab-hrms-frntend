// src/pages/admin/SalarySlip.jsx
...
export function AdminSalarySlips() {
  ...
  const fetchSlips = async () => {
    ...
    try {
      ...
      setError("Unable to load salary slips. Please try again later.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            View and download historically generated salary records.
          </p>
        </div>
      </div>
      ...
      <GovCard className="p-0 overflow-hidden border-gray-200">
        <div className="p-5 border-b border-gray-200 flex justify-between items-center bg-gray-50">
          <h3 className="font-semibold text-gray-700">Salary Slip Directory</h3>
