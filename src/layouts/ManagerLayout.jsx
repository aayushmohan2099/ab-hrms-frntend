...
export function ManagerLayout() {
  ...
  const navLinks = [
    ...
    { path: "/manager/salary-slips", icon: FileText, label: "Salary Slips" },
  ];
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 relative overflow-hidden">
      ...
      {/* Sidebar Navigation */}
      <aside
        className={`fixed md:relative inset-y-0 left-0 z-30 w-64 bg-secondary text-base flex flex-col shadow-lg transform transition-transform duration-300 ease-in-out ${
          isMobileMenuOpen
            ? "translate-x-0"
      ...
      >
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded transition-colors ${
                      isActive
                        ...
                        : "hover:bg-primary-dark text-blue-50"
                    }`}
                  >
                    <Icon size={18} />
        ...
        <div className="p-4 border-t border-blue-700 mt-auto shrink-0 flex items-center justify-between gap-2 bg-secondary">
          <button
            onClick={() => {
              resetModalState();
              setIsPasswordModalOpen(true);
            }}
            className="flex-1 flex items-center justify-center gap-2 font-medium text-sm text-blue-100 hover:text-white hover:bg-primary-dark p-2 rounded transition-colors"
      ...
      <div className="flex-grow flex flex-col min-w-0 w-full md:w-auto h-screen">
        ...
        <header className="bg-base border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center shadow-sm z-10 shrink-0">
          <div className="flex items-center gap-3">
            <button
              className="p-1 -ml-1 text-gray-600 hover:text-primary-dark md:hidden rounded focus:outline-none focus:ring-2 focus:ring-secondary"
