  ...
  return (
    <div className="min-h-screen flex bg-gray-50 relative overflow-hidden">
      ...
      >
        ...
        <div className="p-4 border-t border-primary-dark mt-auto shrink-0 bg-accent-navy flex items-center justify-between gap-2">
          <button
            onClick={() => {
              resetModalState();
              setIsPasswordModalOpen(true);
            }}
            className="flex-1 flex items-center justify-center gap-2 font-medium text-sm text-gray-300 hover:text-white hover:bg-primary-dark p-2 rounded transition-colors"
          ...
          <div className="w-px h-6 bg-primary-dark"></div>

          <button
            onClick={handleLogout}
            className="flex-1 flex items-center justify-center gap-2 font-medium text-sm text-red-400 hover:text-white hover:bg-danger p-2 rounded transition-colors"
          >
            <LogOut size={18} />{" "}
